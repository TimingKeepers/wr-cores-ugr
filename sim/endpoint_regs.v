...
`define EP_RFCR_MRU_OFFSET 4
`define EP_RFCR_MRU 32'h0003fff0
...
`define EP_VCR0_VID_VAL_OFFSET 16
`define EP_VCR0_VID_VAL 32'h0fff0000
...
`define ADDR_EP_PFCR                   8'h14
`define EP_PFCR_MM_ADDR_OFFSET 0
`define EP_PFCR_MM_ADDR 32'h0000007f
`define EP_PFCR_MM_DATA_OFFSET 7
`define EP_PFCR_MM_DATA 32'h01ffff80
`define EP_PFCR_MM_WRITE_OFFSET 25
`define EP_PFCR_MM_WRITE 32'h02000000
`define EP_PFCR_ENABLE_OFFSET 26
`define EP_PFCR_ENABLE 32'h04000000
`define ADDR_EP_FCR                    8'h18
